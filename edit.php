...
<center> <div id="main" style="padding:10px">
	 <div class="m1-container m1-card-4 " style="width:70%;background-color:#F0FFF0;margin-top:16px"><form action="checkProfile.php"  class="m1-container" method="POST" onsubmit="return validate()" >
...
?>
         ...
         <h2>Old Password</h2> <input  style="width:42%;;padding:12px" type="password" name="o_pass" id="o">
      
      
            
         <h2>New Password</h2>  <input  style="width:42%;;padding:12px" type="password" name="n_pass" id="n"><br>


	 <h2>Confirm Password</h2>  <input style="width:42%;;padding:12px" type="password" name="c_pass" id="c"><br><br>
	
      
     
	
     <center> <input type="submit" class="m1-btn  m1-theme" name="pro"><br><br>
...
<footer class="m1-container  " style="padding:8px;text-align:center;margin-top:90px;background-color:#D63333;color:white">
