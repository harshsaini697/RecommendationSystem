...
<h2>Name</h2><input  type="text" name="name" style="width:42%;;padding:12px" ><br>
<h2>Email</h2><input  type="text" name="email" style="width:42%;;padding:12px" ><br>
<h2>Feedback</h2><TEXTAREA  name="feedback" ROWS=5 COLS=60  style="width:42%;;padding:12px"></TEXTAREA><br>
<input type="submit" value="Submit" name="feed" class="m1-btn" style="font-size:17px;margin-left:250px;padding:10px">     
 
<a class="il" href = "show.php" class="m1-btn"> See what our users wrote!</a>
</center>  </form>
