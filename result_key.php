...
<center><h1 style="font-family:verdana">Results</h1></center><hr>


 <?php
	
	include('dbconfig3.php');	
	if(isset($_GET['search']))
{
	...
	$sql=" SELECT * FROM testtable WHERE keyword like '%".$query."%'";
         
        $raw_results = mysql_query($sql);
...
<?php
		...
		?>
	<div class = "m1-card-4" style="padding:20px">
        
        <h1 style = "font-size:30px"><?php echo $row[4]; ?></h1>
	<h1 style = "font-size:20px">Visit site: <a class = "set" href="<?php echo $row[3]; ?>"><?php echo $row[3]?></a></h2>
	<h1 style ="font-size:15px"><?php echo $row[2]; ?></h1>
        </div>
        <?php
