...
<center> <div id="main" style="padding:10px">
	...
	<br><p style="color:red" id = "do"></p>
        <h2>Username </h2><input style="width:42%;margin-top:4px;padding:12px" type="text" id="un" onblur="validUser()" name="name" >  </pre><br>

	<h2>Password</h2>      <input style="width:42%;;padding:12px" type="password" id="ps" onblur="validPass()" name="pass"><br>
    
        
       <h2>Email id </h2>       <input  style="width:42%;;padding:12px" type="text" id="mail" onblur="validEmail()" name="email"><br>
        
 
     
        <h2>Phone number</h2>      <input style="width:42%;;padding:12px" type="text" id="pn" onblur="validAge()" name="phone"><br><br>
      
 	  
    
      <input type="submit" class = "m1-btn m1-theme" style="margin-down:58px" name="sign-save" value="Submit"></input><br><br>
      </form>
      </div>
	</div></center>	
