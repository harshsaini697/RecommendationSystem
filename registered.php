...
<center><div id="main">
	<div class="m1-container m1-padding-4 m1-margin-2 m1-card-4 "style="width:40%" >
	<h1>Successfully  registered!!</h1><br><hr>
	<img src = "2.jpg" width = "320" height = "240">
...
<footer class="m1-container  " style="padding:8px;text-align:center;margin-top:55px;background-color:#D63333;color:white">
